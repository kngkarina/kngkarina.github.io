...
typewriter.typeString('nice to meet you!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("student at duke university")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("studying cs and econ")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("classical musician")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("almond milk enthusiast")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("part-time art hobbyist")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
